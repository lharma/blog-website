...
export default function DesignSection() {
  return (
    <div className="w-full flex items-center justify-between text-left bg-[#e67400]">
      {/* text section */}
      ...
      <div className="w-1/2 flex flex-col pt-20">
        ...
        <div className="w-full h-[500px] bg-[url('/hero/domain1.png')] bg-right bg-contain bg-no-repeat"></div>
      </div>
    </div>
  );
}
